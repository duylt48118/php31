                ...
                <div class="h-100">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Sua sản phẩm</h4>
                        </div><!-- end card header -->
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number" name="gia" step="0.01" class="form-control @error('gia') is-invalid @enderror" id="gia"
                                                value="{{$sanPham->gia}}">
                                                @error('gia')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror  
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number" class="form-control      @error('so_luong') is-invalid @enderror" name="so_luong" id="so_luong"
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="date" class="form-control @error('ngay_nhap') is-invalid @enderror" name="ngay_nhap" id="ngay_nhap
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="mt-3">
                                                    ...
                                                    <input type="file" class="form-control @error('hinh_anh') is-invalid @enderror" name="hinh_anh"
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <textarea class="form-control @error('mo_ta') is-invalid @enderror" name="mo_ta" id="mo_ta" rows="4">{{$sanPham->mo_ta}}</textarea 
                                                        value="">
                                                    @error('mo_ta')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror 
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        @error('trang_thai') is-invalid @enderror
                                                            value="1" class="form-check-input" value="">
                                                            @error('trang_thai')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror 
