                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number" class="form-control      @error('so_luong') is-invalid @enderror" name="so_luong" id="so_luong" value="0"
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <textarea class="form-control @error('mo_ta') is-invalid @enderror" name="mo_ta" id="mo_ta" rows="4"></textarea 
                                                        value="{{ old('mo_ta') }}">
                                                    @error('mo_ta')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror 
