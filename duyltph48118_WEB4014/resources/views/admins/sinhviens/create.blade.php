                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="text" class="form-control @error('ten_sinh_vien') is-invalid @enderror"
                                                 name="ten_sinh_vien"
                                                    id="ten_sinh_vien" placeholder="Nhập tên sinh viên" 
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="text" class="form-control      @error('so_dien_thoai') is-invalid @enderror" name="so_dien_thoai" id="so_dien_thoai" 
